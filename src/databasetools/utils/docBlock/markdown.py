...
class DocBlock2Md:
    ...
    def make_token(self, block: DocBlockElement) -> Dict[str, Any]:
        ...
        if b_type in self.func_list:
            try:
                ...
                raise Exception(f"While parsing block: {block}")
        else:
    ...
    def _text(self, block: DocBlockElement) -> Dict[str, Any]:
        return {
            "type": DocBlockElementType.TEXT.value,
            "raw": block.block_content
        }
        
    def _emphasis(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        return {
            "type": DocBlockElementType.EMPHASIS.value,
            "children": child_list
        }
    ...
    def _strong(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        return {
            "type": DocBlockElementType.STRONG.value,
            "children": child_list
        }
    ...
    def _paragraph(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        return {
            "type": DocBlockElementType.PARAGRAPH.value,
            "children": child_list
        }
    ...
    def _heading(self, block: DocBlockElement) -> Dict[str, Any]:
        ...
        return {
            "type": DocBlockElementType.HEADING.value,
            "attrs": {"level": level},
            "children": child_list
        }
    ...
    def _thematic_break(self, block: DocBlockElement) -> Dict[str, Any]:
        return {
            "type": DocBlockElementType.THEMATIC_BREAK.value
        }
        
    def _block_text(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        return {
            "type": DocBlockElementType.BLOCK_TEXT.value,
            "children": child_list
        }
    ...
    def _block_code(self, block: DocBlockElement) -> Dict[str, Any]:
        ...
        return {
            "type": DocBlockElementType.BLOCK_CODE.value,
            "attrs": attrs,
            "raw": block.block_content
        }
    ...
    def _block_quote(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        return {
            "type": DocBlockElementType.BLOCK_QUOTE.value,
            "children": child_list
        }
    
    def _block_html(self, block: DocBlockElement) -> Dict[str, Any]:
        return {
            "type": DocBlockElementType.BLOCK_HTML.value,
            "raw": block.block_content
        }
    ...
    def _list(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        attrs = {
            "ordered": True if block.block_attr["ordered"] else False,
            "depth": block.block_attr.get("depth")
        }
        return {
    ...
    def _list_item(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        return {
            "type": DocBlockElementType.LIST_ITEM.value,
            "children": child_list
        }
    ...
    def _table_cell(self, block: DocBlockElement) -> Dict[str, Any]:
        child_list = self.make_children_token(block)
        attrs = {
            "align": block.block_attr.get("align"),
            "head": block.block_attr.get("head")
        }
        return {
            "type": DocBlockElementType.TABLE_CELL.value,
            "children": child_list,
            "attrs": attrs
        }
...
class Md2DocBlock:
    ...
    def _emphasis(self, token: Dict[str, Any]) -> DocBlockElement:
        ...
        return DocBlockElement(
            type=DocBlockElementType.EMPHASIS,
            children=id_list
        )
    ...
    def _strong(self, token: Dict[str, Any]) -> DocBlockElement:
        id_list = self.make_children_blocks(token)
        return DocBlockElement(
            type=DocBlockElementType.STRONG,
            children=id_list
        )
    ...
    def _block_text(self, token: Dict[str, Any]) -> DocBlockElement:
        id_list = self.make_children_blocks(token)
        return DocBlockElement(
            type=DocBlockElementType.BLOCK_TEXT,
            children=id_list
        )
...
class MissingBlockElements(Exception):
    def __init__(self, id: ObjectId) -> None:
        super().__init__(f"Missing block with id: {str(id)}")